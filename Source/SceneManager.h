...
private:
	...
	void AddExactCollisionBox(const glm::vec3& scale, float rotX, float rotY, float rotZ,
...
public:
	...
	const std::vector<AABB>& GetCollisionBoxes() const {
		return m_collisionBoxes;
	}
	void AddCollisionBox(const glm::vec3& min, const glm::vec3& max, const std::string& name);
};